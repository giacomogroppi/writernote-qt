...
StrokePre::StrokePre(Fn<void()> callUpdate)
    ...
    , _timer(new WTimer(this, this->_timerEndLambda, _timerTime, WTimer::Flag::onMainThread))
...
StrokePre::StrokePre(const StrokePre &other) noexcept
    ...
    , _img(other._img)
    , _stroke(other._stroke->clone())
    , _timer(new WTimer(this, _timerEndLambda, _timerTime, WTimer::Flag::onMainThread))
    , _point(other._point)
