...
bool pen_ui::touchBegin(const QPointF &point, double size, Document &doc)
{

}

bool pen_ui::touchUpdate(const QPointF &point, double size, Document &doc)
{
    uchar alfa;
    point_s tmp_point{};
...
int pen_ui::touchEnd(const QPointF &, Document &doc)
{
